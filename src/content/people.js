...
export const peopleCz = {
  ...
  phdStudents: [
    ...
    },
    {
      ...
      name: `Šárka Špániková`,
      position: `Doktorand, výzkumník`,
      description: `Šárka Špániková studovala na Přírodovědecké fakultě Masarykovy university obor učitelství biologie pro střední školy spolu s učitelstvím geografie a kartografie pro střední školy (dokončeno 2018) a obor zoologie (dokončeno 2019). V diplomové práci z učitelského oboru se věnuje modelům rozšíření suchozemských plžů v Bílých Karpatech, na doktorském studiu využívá podobné metody pro modely vybraných evropských biotopů. `,
      email: `408322@mail.muni.cz`,
      phoneNumber: ``,
